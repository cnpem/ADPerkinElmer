...
/**
 *  @ingroup misc_dstruct
 *
 *  @brief
 *      Structure of hardware header information.
 *
 */
typedef struct
{
    DWORD   dwPROMID;                   /**<    ID of PROM memory content                                                           */
    DWORD   dwHeaderID;                 /**<    Version ID of header structure                                                      */
    BOOL    bAddRow;                    /**<    reserved                                                                            */
    BOOL    bPwrSave;                   /**<    reserved                                                                            */
    DWORD   dwNrRows;                   /**<    Number of rows                                                                      */
    DWORD   dwNrColumns;                /**<    Number of columns                                                                   */
    DWORD   dwZoomULRow;                /**<    Zoom coordinate row of upper left corner                                            */
    DWORD   dwZoomULColumn;             /**<    Zoom coordinate column of upper left corner                                         */
    DWORD   dwZoomBRRow;                /**<    Zoom coordinate row of bottom right corner                                          */
    DWORD   dwZoomBRColumn;             /**<    Zoom coordinate column of bottom right corner                                       */
    DWORD   dwFrmNrRows;                /**<    reserved                                                                            */
    DWORD   dwFrmRowType;               /**<    reserved                                                                            */
    DWORD   dwFrmFillRowIntervalls;     /**<    reserved                                                                            */
    DWORD   dwNrOfFillingRows;          /**<    reserved                                                                            */
    DWORD   dwDataType;                 /**<    reserved                                                                            */
    DWORD   dwDataSorting;              /**<    Detector readout sorting scheme                                                     */
    DWORD   dwTiming;                   /**<    Detector readout timing (bits 0 up to 3) (bit 4 indicates triggered mode if set)    */
    DWORD   dwAcqMode;                  /**<    reserved                                                                            */
    DWORD   dwGain;                     /**<    Selected gain of analogue circuit                                                   */
    DWORD   dwOffset;                   /**<    reserved                                                                            */
    DWORD   dwAccess;                   /**<    reserved                                                                            */
    BOOL    bSyncMode;                  /**<    reserved                                                                            */
    DWORD   dwBias;                     /**<    reserved                                                                            */
    DWORD   dwLeakRows;                 /**<    reserved                                                                            */
} CHwHeaderInfo;
 ...
 *
 *  @brief
 *      Structure of extended hardware header information.
 *
 */
typedef struct
{
    WORD    wHeaderID;              /**<    Version ID of header structure                                                      */      /*  0       */
    WORD    wPROMID;                /**<    ID of detector control PROM revision                                                */      /*  1       */
    WORD    wResolutionX;           /**<    Glass Pixel pitch x-axis                                                            */      /*  2       */
    WORD    wResolutionY;           /**<    Glass Pixel pitch y-axis                                                            */      /*  3       */
    WORD    wNrRows;                /**<    Number of rows                                                                      */      /*  4       */
    WORD    wNrColumns;             /**<    Number of columns                                                                   */      /*  5       */
    WORD    wZoomULRow;             /**<    Zoom coordinate row of upper left corner                                            */      /*  6       */
    WORD    wZoomULColumn;          /**<    Zoom coordinate column of upper left corner                                         */      /*  7       */
    WORD    wZoomBRRow;             /**<    Zoom coordinate row of bottom right corner                                          */      /*  8       */
    WORD    wZoomBRColumn;          /**<    Zoom coordinate column of bottom right corner                                       */      /*  9       */
    WORD    wFrmNrRows;             /**<    reserved                                                                            */      /*  A       */
    WORD    wFrmRowType;            /**<    reserved                                                                            */      /*  B       */
    WORD    wRowTime;               /**<    reserved                                                                            */      /*  C << 6  */
    WORD    wClock;                 /**<    reserved                                                                            */      /*  D << 6  */
    WORD    wDataSorting;           /**<    Detector readout sorting scheme                                                     */      /*  E       */
    WORD    wTiming;                /**<    Detector readout timing (bits 0 up to 3) (bit 4 indicates triggered mode if set)    */      /*  F       */
    WORD    wGain;                  /**<    Selected gain of analogue circuit                                                   */      /* 10       */
    WORD    wLeakRows;              /**<    reserved                                                                            */      /* 11       */
    WORD    wAccess;                /**<    reserved                                                                            */      /* 12       */
    WORD    wBias;                  /**<    reserved / XRD4343  detector control minor version                                  */      /* 13       */
    WORD    wUgComp;                /**<    reserved / XRD4343                                                                  */      /* 14       */
    WORD    wCameratype;            /**<    Detector camera type ID                                                             */      /* 15       */
    WORD    wFrameCnt;              /**<    Frame counter value (16 bit unsigned integer, modular arithmetic)                   */      /* 16       */
    WORD    wBinningMode;           /**<    Selected detector device binning mode                                               */      /* 17       */
    WORD    wRealInttime_milliSec;  /**<    Integration time milliseconds part                                                  */      /* 18       */
    WORD    wRealInttime_microSec;  /**<    Integration time microseconds part                                                  */      /* 19       */
    WORD    wStatus;                /**<    Composit word. Not mentioned bits are reserved.<BR>
                                     *      Bits  | Description                                        |
                                     *      ----- | ---------------------------------------------------|
                                     *      3,2,1 | Trigger mode (please see XIS_DetectorTriggerMode)  |
                                     *      0     | Trigger status                                     |                        */      /* 1A       */
    WORD    wCommand1;              /**<    reserved                                                            */      /* 1B       */
    WORD    wCommand2;              /**<    reserved                                                            */      /* 1C       */
    WORD    wCommand3;              /**<    reserved                                                            */      /* 1D       */
    WORD    wCommand4;              /**<    reserved                                                            */      /* 1E       */
    WORD    wDummy;                 /**<    reserved / detector dependent detector control PROM sub-revision    */      /* 1F       */
}   CHwHeaderInfoEx;
 ...
 *
 *  @brief
 *      Structure of "HIS"-file file header (HeaderVersion == 100)
 *
 */
typedef struct
{
    ...
    WORD    Correction;             /**<    Enabled corrections bit mask: bit 0 = offset, bit 1 = gain (with single gain image), bit 2 = bad pixel, bit 3 = gain-sequence */
 ...
 *
 *  @brief
 *      Structure of "HIS"-file file header (HeaderVersion == 101)
 *
 */
typedef struct
{
...
typedef struct
{
    unsigned char   wTiming;        /**<    Timing and Triggermode  */
...
} FPGAType;                 /* 8 Bytes are transfered  */
...
/** @brief Possible system control actions for XRpad
* @ingroup enum
*/
typedef enum
{
...
{
    char            index;                  /**< The internal unique sensor index. Used for service purposes only                                 */
    char            name[32];               /**< The internal unique name of the sensor. Used for service purposes only                           */
    BOOL            is_virtual;             /**< True if the value is a calculated value based on temperature readings from physical temperature sensors. False if the measurement comes from an actual sensor. */
    unsigned char   warn_level;             /**< The warning level of the sensor. 0: warning level reached, 1: critical temperature reached.      */
    double          temperature;            /**< The temperature measured by the sensor is reported with a numerical resolution of a 1000th of a degree Celcius, e.g. 40000 is 40 degrees Celcius. */
} XRpad_TempSensor;
...
{
    unsigned char       system_warn_level;  /**< 0: Warning. 1: Detector reached critical temperature and will initiate a shutdown.         */
    unsigned char       sensor_count;       /**< The number of sensors that are reporting updates.                                          */
    unsigned int        shutdown_time;      /**< Number of seconds when the detector will shut down due to critical temperature.            */
    XRpad_TempSensor    sensors[16];        /**< Updates from the sensors. sensor_count indicates how many of the structures are populated. */
...
{
    XRpad_NO_BATTERY        = 0,    /**< No battery detected                */
 ...
 * @ingroup enum
 *
 * @note The value returned by the shock sensors is the number of triggers measured. It is not a measurement of how hard the shock was.
 */
typedef struct XRpad_ShockEvent
{
    unsigned int    timestamp;                    /**< The number of seconds since January 1, 1970, 0:00 UTC when the shock event occured.*/
    unsigned int    critical_sensor1;             /**< Number of critical triggers reported by sensor 1. */
    unsigned int    critical_sensor2;             /**< Number of critical triggers reported by sensor 2. */
    unsigned int    critical_sensor3;             /**< Number of critical triggers reported by sensor 3. */
    unsigned int    warning_sensor1;              /**< Number of warning triggers reported by sensor 1. */
    unsigned int    warning_sensor2;              /**< Number of warning triggers reported by sensor 2. */
    unsigned int    warning_sensor3;              /**< Number of warning triggers reported by sensor 3. */
} XRpad_ShockEvent;
...
{
    XRpad_ShockEvent largest;                /**< The strongest shock event in the shock data file. Acquisition_ResetOnboardShockEvent will reset this value.   */
    XRpad_ShockEvent latest;                 /**< The most recent shock event in the shock data file. Acquisition_ResetOnboardShockEvent will reset this value. */
...
* See Acquisition_SetLogLevel() and Acquisition_GetLogLevel() for further information.
* @ingroup enum
*/
typedef enum
{
    LEVEL_TRACE     = 0,                /**< Log level Trace. Reserved                                */
    LEVEL_DEBUG,                        /**< Log level Debug. Reserved                                */
    LEVEL_INFO,                         /**< Log level Info. Used for common events                   */
    LEVEL_WARN,                         /**< Log level Warning. Indicates an unexpected event         */
    LEVEL_ERROR,                        /**< Log level Error. Indicates a function failure            */
    LEVEL_FATAL,                        /**< Log level Fatal. A fatal unrecoverable error occured     */
    LEVEL_ALL,                          /**< Log level All. Use this for Acquisition_SetLogLevel() to retrieve all log messages */
    LEVEL_NONE                          /**< Log level None. Reserved                                 */
} XislLoggingLevels;
...
{
    PREBINNING,         ///< Reserved. Do not use!
    PREMEAN,            ///< Reserved. Do not use!
    PRESTOREBUFFER,     ///< Reserved. Do not use!
    OFFSET,             ///< Offset correction
    GAIN,               ///< Gain correction (do not use in dual enmergy mode!)
    MEAN,               ///< Pixel correction
    PREVIEW,            ///< Reserved. Do not use!
    BINNING,            ///< Reserved. Do not use!
    STOREBUFFER,        ///< Reserved. Do not use!
    STORESD,            ///< Reserved. Do not use!
    SEND,               ///< Reserved. Do not use!
    OFFSET_2,           ///< Offset correction of second bright image in dual energy mode
    GAIN_2,             ///< Reserved. Do not use!
    AVERAGE_1,          ///< Reserved. Do not use!
    AVERAGE_2           ///< Reserved. Do not use!
} ProcScriptOperation;
...
{
    ONBOARDBINNING2x1   = 0,      ///< Reserved. Do not use!
    ONBOARDBINNING2x2   = 1,      ///< Reserved. Do not use!
    ONBOARDBINNING4x1   = 2,      ///< Reserved. Do not use!
    ONBOARDBINNING4x4   = 3,      ///< 4x binning in vertical and horizontal direction.
    ONBOARDBINNING3x3   = 4,      ///< Reserved. Do not use!
    ONBOARDBINNING9to4  = 5       ///< Reserved. Do not use!
} OnboardBinningMode;
...
typedef enum XIS_DetectorTriggerMode
{
    ...
    TRIGGERMODE_SEQUENCE,
    TRIGGERMODE_DDD_POST_OFFSET_WITH_PRESHOT,
    TRIGGERMODE_DDD_DUAL_POST_OFFSET_WITH_PRESHOT,

    TRIGGERMODE_LAST = TRIGGERMODE_DDD_DUAL_POST_OFFSET_WITH_PRESHOT
...
typedef enum XIS_Detector_TRIGOUT_SignalMode
{
    ...
    TRIGOUT_SIGNAL_GND,
    TRIGOUT_SIGNAL_VCC,
    TRIGOUT_SIGNAL_SEQUENCE,
    TRIGOUT_SIGNAL_SEQUENCE_INV
 ...
 *   List of event types.
 * @note
 *   You receive XIS_Event as parameter event of XIS_EventCallback.\n
 *   Events of type #XE_LIBRARY_EVENT can be signaled for all supported detectors. Other events can only be signaled for detectors of the XRpad2/XRD3025 series.
 */
typedef enum XIS_Event
{
    XE_ACQUISITION_EVENT = 0x00000001,                       /**<    Acquisition event. Parameters value1 and value2 of XIS_EventCallback are of type XIS_Acquisition_Event. Parameter value1 contains the actual state, value2 indicates the bits that changed (i.e. triggered the event). See XIS_Acquisition_Event */
    XE_SENSOR_EVENT      = 0x00000002,                       /**<    Sensor event. Parameter value1 of XIS_EventCallback is of type XIS_Sensor_Event. Parameters value2 and/or pAdditionalData depend on the type of sensor that triggered the event. See XIS_Sensor_Event */
    XE_SDCARD_EVENT      = 0x00000004,                       /**<    SD card event. Parameter value1 of XIS_EventCallback is the total number of bytes available on the SD card. Parameter value2 is the number of available bytes on the SD card.*/
    XE_BATTERY_EVENT     = 0x00000005,                       /**<    Battery event. Parameter value1 of XIS_EventCallback is of type XIS_Battery_Event. Parameters value2 and/or pAdditionalData depend on the type of battery event. See XIS_Battery_Event  */
    XE_LOCATION_EVENT    = 0x00000006,                       /**<    Location event. Parameter value1 of XIS_EventCallback contains the location. */
    XE_NETWORK_EVENT     = 0x00000007,                       /**<    Network event. Parameter value1 of XIS_EventCallback contains the network speed in mbps. */
    XE_DETECTOR_EVENT    = 0x00000008,                       /**<    Detector event. Parameter value1 of XIS_EventCallback is of type XIS_Detector_Event. Parameters value2 and/or pAdditionalData depend on the type of detector event. See XIS_Detector_Event  */
    XE_LIBRARY_EVENT     = 0x00000009,                       /**<    XISL library event. Parameter value1 of XIS_EventCallback contains the library event which is of type XIS_Library_Event. */
    XE_SDCARD_FSCK_EVENT = 0x0000000A,                       /**<    SD card file system event. 1: An FSCK request was received with a previous FSCK still outstanding, i.e. it was not confirmed with Acquisition_AckSDCardForceFsckError. 2: An error was fixed. 3: Unrecoverable error. 4: FSCK was executed. 5: FSCK was requested. pAdditionalData may contain results from an FSCK. See Appendix "SD card fsck events" */
    XE_XRPD_EVENT        = 0x0000000B,                       /**<    XRpad daemon event. Parameter value1 of XIS_EventCallback is of type XIS_Xrpd_Event. Parameters value2 and/or pAdditionalData depend on the type of xrpd event. See XIS_Xrpd_Event */
} XIS_Event;
 ...
 *
 * @brief
 *   Bitmasks for en-/decoding acquisition events from transmitted values.
 * @note
 *   You will receive XIS_Acquisition_Event as parameters value1 and value2 of XIS_EventCallback when receiving an XE_ACQUISITION_EVENT
 *
 */
typedef enum XIS_Acquisition_Event
{
    XAE_TRIGOUT          = 0x00000002,                      /**<    Bit indicates the Trigger Out status (high/low).      */
    XAE_READOUT          = 0x00000004,                      /**<    Bit indicates the Read-out status (ongoing/inactive). */
    XAE_TRIGGERED        = 0x00000008,                      /**<    Reserved for internal use only. */
    XAE_AED_READY        = 0x00000010,                      /**<    Reserved        */
...
*
* @brief
*   Enum indicating the type of sensor that triggered the event.
* @note
*   You will receive XIS_Sensor_Event as parameter value1 of XIS_EventCallback when receiving an XE_SENSOR_EVENT
*/
typedef enum XIS_Sensor_Event
{
    XSE_HALL                            = 0x00000001,       /**<    Hall sensor event. Value2 of XIS_EventCallback will indicate the status of the Hall Sensors. */
    XSE_SHOCK                           = 0x00000010,       /**<    Shock sensor event. pAdditionalData of XIS_EventCallback will contain a pointer to an XRpad_ShockSensorReport. */
    XSE_TEMPERATURE                     = 0x00000020,       /**<    Temperature sensor event. pAdditionalData of XIS_EventCallback will contain a pointer to an XRpad_TempSensorReport. */
    XSE_TEMPERATURE_BACK_TO_NORMAL      = 0x00000021,       /**<    Temperature back to normal event. The temperature is back to normal. */
    XSE_THERMAL_SHUTDOWN                = 0x00000022,       /**<    Temperature shutdown initiated event. The system is overheated and the shutdown was initiated. */
} XIS_Sensor_Event;
...
*
* @brief
*   Enum indicating types of battery events.
* @note
*   You will receive XIS_Battery_Event as parameter value1 of XIS_EventCallback when receiving an XE_BATTERY_EVENT
*/
typedef enum XIS_Battery_Event
{
    XBE_BATTERY_REPORT                  = 0x00000001,       /**<    Battery status reporting event. If pAdditionalData of XIS_EventCallback is NULL then the battery was removed. Otherwise the battery is/was inserted and pAdditionalData contains a pointer to an XRpad_BatteryStatus that indicates the current battery status. */
    XBE_BATTERY_WARNING                 = 0x00000002,       /**<    Battery charge state warning event. Value2 of XIS_EventCallback contains the current charge in percentage. */
} XIS_Battery_Event;
...
*
* @brief
*   Enum indicating the type of a detector event.
* @note
*   You will receive XIS_Detector_Event as parameter value1 of XIS_EventCallback when receiving an XE_DETECTOR_EVENT
*/
typedef enum XIS_Detector_Event
{
    XDE_BUFFERS_IN_USE                  = 0x00000001,       /**<    value 2: Number of internal detector image buffers used for StoreToSD option.               */
    XDE_STORED_IMAGE                    = 0x00000002,       /**<    Event to report storing image on SD card. pAdditionalData contains filename as const char*. */
    XDE_DROPPED_IMAGE                   = 0x00000003,       /**<    Event to report image drop if all internal image buffers are in use and image can not be stored to SD card. */
    XDE_POWER_STATE_CHANGED             = 0x00000004,       /**<    value 2 success: New power state (DeepSleep = 0x03; Idle = 0x04). Please be aware that the next acquisition needs to be proper configured after switching from DeepSleep to Idle. The device does not maintain acquisition settings. */
    XDE_POWER_STATE_CHANGE_FAILED       = 0x00000005,       /**<    value 2 error: Code XRPD_ERROR_SWITCH_PWR_STATE_BLOCKED_BY_EXAM 0x0052 (ongoing acquisition, not able to change power state), any other: internal error */
    XDE_PB_SHUTDOWN_REQUESTED           = 0x00000006,       /**<    Shutdown requested on detector via push button circuit activation. pAdditionalData contains a string (const char*) with additional information that can be used for logging purposes (e.g. date and time of request). */
    XDE_PB_NETWORK_FACTORY_RESET_REQUESTED = 0x00000007,    /**<    Network factory reset requested on detector via push button circuit activation. pAdditionalData contains a string (const char*) with additional information that can be used for logging purposes (e.g. date and time of request) */
} XIS_Detector_Event;
...
*
* @brief
*   Enum indicating the type of a library event.
* @note
*   You will receive XIS_Library_Event as parameter value1 of XIS_EventCallback when receiving an XE_LIBRARY_EVENT
*/
typedef enum XIS_Library_Event
{
    ...
    XLE_HIS_ERROR_FRAME_ACKNOWLEDGEMENT     = 0x00000002, /**<    Frame acknowledgement mechanism failed (used in safe transfer mode). */
    XLE_HIS_ERROR_WAIT_FOR_EVENT_FAILED     = 0x00000003, /**<    Waiting for an event failed unexpectedly (only relevant in safe transfer mode). */
    XLE_HIS_ERROR_DETECTOR_HEARTBEAT_FAILED = 0x00000004, /**<    Periodic XISL to detector heartbeat was not successful. */
    XLE_HIS_WARN_FRAMES_PROCESSED_SLOWLY    = 0x00000005, /**<    Number of End Of Frame events to be processed exceeds half of the length of the intermediate image buffer.\n
                                                           *      This warning points to a slow processing of End Of Frame events, which might result in loosing frames.\n
                                                           *      value2 contains the current number of End Of Frame events pending for processing.\n
                                                           *      The length of the intermediate image buffer can be read using \ref Acquisition_GetNrOfImagesInIntermetiateBuff */
    XLE_HIS_ERROR_IRQ_NOTIFICATION_FAILED   = 0x00000006, /**<    Internal IRQ notification failed (results in possible frame loss) */
    XLE_HIS_ERROR_ACQ_ABORTED_BY_XISL       = 0x00000007  /**<    The running acquisition was aborted by the xisl due to a detected error (e.g. invalid HW header) */
} XIS_Library_Event;
...
*
* @brief
*   Enum indicating the type of an xrpd event.
* @note
*   You will receive XIS_Xrpd_Event as parameter value1 of XIS_EventCallback when receiving an XE_XRPD_EVENT
*/
typedef enum XIS_Xrpd_Event
{
    XXE_CONNECTION_LOST                 = 0x00000001,       /**<    Connection to XRpad Daemon lost. The SDK tries to re-establish the connection automatically. Value2 of XIS_EventCallback contains an error code. The error code is of type int.*/
...
/**
 * @ingroup enum
 * Options of framegrabber trigger output GPOUT[0] route
 */
typedef enum XIS_GrabberTriggerRoute
{
    TR_RT_FRAMEEN,              //!< Route frame enable signal to GPOUT[0] (default)
    TR_RT_DETECTOR_TRIGOUT,     //!< Route detector's trigger output signal to GPOUT[0]
    //!< @see Acquisition_SetTriggerOutSignalOptions() to define
    //!< detector's trigger output behaviour.
 ...
 *
 * @brief
 *  Typedefinition of callback function type.
 *
 * @param   event               Event type
 * @param   value1              First value of event
 * @param   value2              Second value of event
 * @param   pAdditionalData     Pointer to optional or additional event-related information
 * @param   userData            Pointer to user data
 *
 * @note    Please see XISL function "Acquisition_SetEventCallback()" for more details about userData.
 *
 */
typedef void (*XIS_EventCallback)(XIS_Event event, UINT value1, UINT value2, void *pAdditionalData, void *userData);
...
{
    XTM_LIVE = 0x00000001, /**< All images are sent out directly as they are acquired (supported by all devices) */
    XTM_SAFE = 0x00000002  /**< Images are sent out when the previous was completely received (supported only by devices of the XRpad2/XRD3025 detector series) */
} XIS_Transmission_Mode;


/**
* @ingroup enum
* @brief   Enumeration of possible keys to read-out values from the detector to be used with Acquisition_ReadDetectorValues().
* @note    This enumeration may be extended in upcoming releases.
*/
typedef enum XisReadoutKey
{
    /**
    * @brief   Read-out the temperature sensor(s) of a detector if supported by the device
    * @details Queries temperature sensor values in Kelvin/100.
    *          Depending on the type of detector used, the number and position of the sensors may vary.
    *          # E.g.: *XRD4343 HS*
    *            * 3 sensors are reported by Acquisition_ReadDetectorValues():
    *               * Sensor 0 is located by the readout modules
    *               * Sensor 1 is located by the row drivers
    *               * Sensor 2 is located by the digital board
    */
    XIS_READ_TEMPERATURES_KEY,

    XIS_READ_KEYCOUNT   ///< Reserved for plausibility check
} XisReadoutKey;
...
struct deviceInfo
{
    ...
    char manufacturer_specific[48];      /**< Some manufacture information  */
...
struct discoveryReplyEx
{
    ...
    unsigned messageCount;                  /**< Number of messages this reply carries          */
};
...
HIS_RETURN Acquisition_DoOffsetGainCorrection_Ex(WORD *pSource, WORD *pDest, WORD *pOffsetData, WORD *pGainData,
                                                 WORD *pGainAVG, int nCount, int nFrame);
...
HIS_RETURN Acquisition_DoOffsetGainCorrection_Ex32(unsigned long *pSource, unsigned long *pDest, unsigned long *pOffsetData, unsigned long *pGainData,
                                                   unsigned long *pGainAVG, int nCount, int nFrame);
...
HIS_RETURN Acquisition_ActivateCorrectionSet(HACQDESC hAcqDesc, unsigned int corrSet);
...
HIS_RETURN Acquisition_Set_OnboardOffsetImageAcquisitionDualEnergy(HACQDESC hAcqDesc, BOOL bEnable, BOOL bSend, BOOL bStoreSD, BOOL setForSecondBrightImage);

HIS_RETURN Acquisition_Set_OnboardAVGOptions(HACQDESC hAcqDesc, const BOOL BobAVG_en, const WORD wNumFrms);
...
HIS_RETURN Acquisition_Grabber_SetTriggerRoute(HACQDESC hAcqDesc, XIS_GrabberTriggerRoute route);
...
HIS_RETURN Acquisition_GetTriggerOutStatus(HACQDESC hAcqDesc, int *iTriggerStatus);     /* GetTriggerStatus GbIF     */

HIS_RETURN Acquisition_SetCameraFOVMode(HACQDESC hAcqDesc, WORD wMode);                 /*  R&F Field Of View         */
HIS_RETURN Acquisition_GetCameraFOVMode(HACQDESC hAcqDesc, WORD *wMode);                /*  R&F Field Of View         */
...
HIS_RETURN Acquisition_FreeFTPFileBuffer(void *databuffer);
HIS_RETURN Acquisition_SetFTPFile(const char *ipAddress, const char *filename, void *databuffer, long filesize);

HIS_RETURN Acquisition_GetVersion(int *major, int *minor, int *bugfix, int *arch);
HIS_RETURN Acquisition_GetVersionString(char *versionBuffer, size_t versionBufferSize);
...
HIS_RETURN Acquisition_SetPreshotParams(HACQDESC hAcqDesc, unsigned short usMaxDelay);
HIS_RETURN Acquisition_SetSequencedModeOptions(HACQDESC hAcqDesc, unsigned short numFrames, unsigned short cycleTime);
...
HIS_RETURN Acquisition_GetNrOfImagesInIntermetiateBuff(HACQDESC hAcqDesc, UINT *nrOfImages);
HIS_RETURN Acquisition_SetNrOfImagesInIntermetiateBuff(HACQDESC hAcqDesc, UINT nrOfImages);
HIS_RETURN Acquisition_ResetNrOfImagesInIntermetiateBuff(HACQDESC hAcqDesc);

HIS_RETURN Acquisition_ReadDetectorValues(HACQDESC hAcqDesc, XisReadoutKey valueKey, unsigned int (*values)[8], unsigned char *valueCount);
...
/** Unable to initialize board. Could not connect to device. Check that device is not already initialized. Check cables, driver, network settings, etc... Refer to appendix "FAQ" for further information. @ingroup enum **/
...
/** Error setting onboard offset correction mode. @ingroup enum **/
#define HIS_ERROR_ENABLE_ONBOARD_OFFSET             66
/** Error setting onboard mean (pixel) correction mode. @ingroup enum **/
#define HIS_ERROR_ENABLE_ONBOARD_MEAN               67
/** Error setting onboard gain correction mode. @ingroup enum **/
...
/** DEXELA  (just for internal purposes) **/
#define HIS_ERROR_SERIALREAD                        100
/** DEXELA  (just for internal purposes) **/
#define HIS_ERROR_SERIALWRITE                       101
/** 1313    (just for internal purposes) **/
...
/** Error retrieving the SD card information. @ingroup enum **/
...
/** Unable to get on detector WLAN country code information. @ingroup enum **/
...
/** Unable to get on detector WLAN channel list information. @ingroup enum **/
...
#define HIS_SORT_OCT_TILE_INVERSE_BINDING   9       /*  deprecated!                                            */
...
#define HIS_SORT_TOP_BOTTOM                 15      /*  1717 RNF  full lines top row bottom row */


/// @ingroup seq_acq_options
/// @{ */
#define HIS_SEQ_TWO_BUFFERS             0x1    ///< Storage of the sequence into two buffers. Secure image acquisition by separated data transfer and later performed image correction.
#define HIS_SEQ_ONE_BUFFER              0x2    ///< Storage of the entire sequence into one buffer that accommodates all frames. Direct acquisition and linked correction into one buffer.
#define HIS_SEQ_AVERAGE                 0x4    ///< All acquired single images are directly added into one buffer and after acquisition divided by the number of frames, including linked correction files.
#define HIS_SEQ_DEST_ONE_FRAME          0x8    ///< Sequence of frames using the same image buffer
#define HIS_SEQ_COLLATE                 0x10   ///< Skip frames after acquiring frames in a ring buffer
#define HIS_SEQ_CONTINUOUS              0x100  ///< Continuous acquisition, frames are continuously acquired into a ring buffer of dwFrames
#define HIS_SEQ_LEAKAGE                 0x1000 ///< Reserved (must not be used)
#define HIS_SEQ_NONLINEAR               0x2000 ///< Reserved (must not be used)
#define HIS_SEQ_AVERAGESEQ              0x4000 ///< Sequence of averaged frames
#define HIS_SEQ_PREVIEW                 0x8000 ///< Reserved (must not be used)
/// @} */
...
#define HIS_BOARD_TYPE_ELTEC                    0x1     /* XRD-FG or XRD-FGe frame grabber using HIIB */
#define HIS_BOARD_TYPE_DIPIX                    0x2     /* Not supported */
#define HIS_BOARD_TYPE_RS232                    0x3     /* Not supported */
#define HIS_BOARD_TYPE_USB                      0x4     /* Not supported */
#define HIS_BOARD_TYPE_ELTEC_XRD_FGX            0x8     /* XRD-FGx PCIx optical frame grabber. Not supported anymore. */
#define HIS_BOARD_TYPE_ELTEC_XRD_FGE_Opto       0x10    /* XRD-FGe Opto frame grabber */
#define HIS_BOARD_TYPE_ELTEC_GbIF               0x20    /* Gigabit Ethernet connection */
#define HIS_BOARD_TYPE_ELTEC_WPE                0x40    /* Additional WPE library functions */
#define HIS_BOARD_TYPE_ELTEC_EMBEDDED           0x60    /* embedded is gbif and wpe */


#define HIS_BOARD_TYPE_CMOS                     0x100   /* CMOS are all devices with CMOS FW (until now 1512, 13x13) / => HIS_BOARD_TYPE_DEXELA_1512 | define HIS_BOARD_TYPE_ELTEC_13x13 (just for internal purposes) */
/*#define HIS_BOARD_TYPE_ELTEC_13x13            0x200   (just for internal purposes) */
#define HIS_BOARD_TYPE_ELTEC_13x13              0x320   /* 13x13 includes gbif and CMOS / => 0x200 | HIS_BOARD_TYPE_ELTEC_GbIF | HIS_BOARD_TYPE_CMOS     (just for internal purposes) */
/*#define HIS_BOARD_TYPE_DEXELA_1512CL          0x400   (just for internal purposes) */
#define HIS_BOARD_TYPE_DEXELA_1512CL            0x500   /* 13x13 includes and CMOS / => 0x400 | HIS_BOARD_TYPE_CMOS      (just for internal purposes) */
